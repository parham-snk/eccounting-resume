    ...
    return (
        <div className="flex flex-col justify-sub items-center z-10 bg-white w-4/5 md:w-1/4 h-4/5 shadow p-4 rounded">
            <div className="flex flex-row justify-center align-middle items-center">
                <input autoFocus ref={field} type="text" className="border border-gray-400 rounded px-2 py-1" placeholder="یافتن محصول" />
            ...
            <div className="flex flex-col justify-start align-top items-baseline"></div>
        </div>
    )
}
