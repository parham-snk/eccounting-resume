...
const Tr = (props) => {
    let {invoice_id,doc_id,custom_date,invoice_type,total_price,eccount_name}=props.data
    // let d=new Date(date).toLocaleString("fa-IR")
    // let dd =d.split(",")[0]
    
    return (
        <tr className="py-2 border-b-0 hover:bg-gray-200 dark:hover:bg-zinc-900 dark:hover:text-white" onDoubleClick={()=>{
