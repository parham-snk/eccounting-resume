...
export default function Proggress() {
    ...
    return (
        <div className="bg-white text-black dark:bg-zinc-700 dark:text-white w-full h-full shadow rounded flex flex-col flex-wrap  justify-around align-middle items-center p-10 md:p-0 overflow-y-scroll">
            <div className="flex flex-col justify-center align-baseline w-full p-3">
                ...
                <div className="flex flex-row justify-start align-middle flex-wrap">
                    <Link to={"/proggres/buyInvoice"} className="m-3">
                        <div className="my-1 md:my-0 w-40 md:w-50 h-40 md:h-50 shadow rounded flex flex-col justify-center items-center dark:text-gray-400 hover:bg-zinc-900 hover:text-white bg-white dark:bg-zinc-800">
